...
class AccountTransferViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, ConfirmActionViewDelegate,InputDataChangeDelegate,SessionTimeOutDelegate {

    @IBOutlet weak var typeTransferCollection: UICollectionView!
    @IBOutlet weak var TransferFormContainer: UIView!
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let cell = dataResponse?.list[indexPath.row]
        {
            ...
            //getAccountsByTransferType(trasferTypeId: cell.id as String)
            self.delegate?.SelectedTransferTypeBack(selectedTransferType: cell)
        }
